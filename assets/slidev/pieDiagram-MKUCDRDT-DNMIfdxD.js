import{p as B}from"./chunk-K2ZEYYM2-DQVRk9P6.js";import{p as U}from"./gitGraph-YCYPL57B-RWHQZFFZ-CbFSbtUk.js";import{E as Z,p as q,q as V,s as X,g as Y,d as j,c as H,_ as i,l as C,t as J,e as K,F as Q,aU as tt,aW as et,aX as z,aY as at,m as rt,aZ as it}from"./md-BIHhVlgh.js";import"./chunk-TZBO7MLI-BthdsaDY.js";import"../monaco/bundled-types-B4UFH0lj.js";import"../modules/vue-BJ3NjBU7.js";import"../modules/file-saver-igGfcqei.js";import"./lz-string-BMV4afKq.js";import"../index-B-b12fiZ.js";import"../modules/shiki-VFpPEGO7.js";import"./default-D-plwul9.js";import"./context-rudbYNSz.js";var F=Z.pie,D={sections:new Map,showData:!1,config:F},m=D.sections,w=D.showData,st=structuredClone(F),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,J()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),W={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:V,setAccTitle:X,getAccTitle:Y,setAccDescription:j,getAccDescription:H,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,W)},"parse")},ft=i(t=>`
  .pieCircle{
