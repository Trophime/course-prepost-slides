import{p as B}from"./chunk-K2ZEYYM2-BbLIhmfX.js";import{p as U}from"./gitGraph-YCYPL57B-RWHQZFFZ-C8oMlndX.js";import{E as Z,p as q,q as V,s as X,g as Y,d as j,c as H,_ as i,l as C,t as J,e as K,F as Q,aU as tt,aW as et,aX as z,aY as at,m as rt,aZ as it}from"./md-DuyNVxiD.js";import"./chunk-TZBO7MLI-C72TTHmL.js";import"../index-BheEQ11y.js";import"../modules/vue-DPBn8Ifk.js";import"../modules/shiki-_-ya_Zgz.js";import"../modules/file-saver-LUhfcczZ.js";import"./two-cols.vue_vue_type_script_setup_true_lang-CBB9sstc.js";import"./context-CSEBpX6z.js";var F=Z.pie,D={sections:new Map,showData:!1,config:F},m=D.sections,w=D.showData,st=structuredClone(F),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,J()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),W={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:V,setAccTitle:X,getAccTitle:Y,setAccDescription:j,getAccDescription:H,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,W)},"parse")},ft=i(t=>`
  .pieCircle{
