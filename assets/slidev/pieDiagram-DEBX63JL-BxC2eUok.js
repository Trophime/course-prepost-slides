import{p as B}from"./chunk-K2ZEYYM2-DpDn7XF2.js";import{p as U}from"./gitGraph-YCYPL57B-5MQDGNWY-DboKH8jI.js";import{ar as V,q,t as X,s as Y,g as Z,d as j,c as H,_ as i,l as C,y as J,e as K,as as Q,aT as tt,aV as et,aW as z,aX as at,m as rt,aY as it}from"./md-BVyanfmS.js";import"./chunk-TGZYFRKZ-Q45EZejn.js";import"../index-Bw83jpUl.js";import"../modules/vue-By3JbpAh.js";import"../modules/shiki-Bdsq0zf_.js";import"../modules/file-saver-CsNJ2AjR.js";import"./two-cols.vue_vue_type_script_setup_true_lang-BpMy0vIw.js";import"./context-D5mFR-44.js";var W=V.pie,D={sections:new Map,showData:!1,config:W},m=D.sections,w=D.showData,st=structuredClone(W),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,J()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:X,setAccTitle:Y,getAccTitle:Z,setAccDescription:j,getAccDescription:H,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},ft=i(t=>`
  .pieCircle{
