import{p as B}from"./chunk-K2ZEYYM2-BnJCkxDL.js";import{p as U}from"./gitGraph-YCYPL57B-RWHQZFFZ-CrBExxrV.js";import{as as Z,q,t as V,s as X,g as Y,d as j,c as H,_ as i,l as C,v as J,e as K,at as Q,aU as tt,aW as et,aX as z,aY as at,m as rt,aZ as it}from"./md-CQOmnaDB.js";import"./chunk-TZBO7MLI-BSSw9Kiv.js";import"../index-Bx9-FrgD.js";import"../modules/vue-CqzGflFA.js";import"../modules/shiki-UU-llots.js";import"../modules/file-saver-LUhfcczZ.js";import"./two-cols.vue_vue_type_script_setup_true_lang-C-zFtbQB.js";import"./context-C6xSXmsR.js";var W=Z.pie,D={sections:new Map,showData:!1,config:W},m=D.sections,w=D.showData,st=structuredClone(W),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,J()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:V,setAccTitle:X,getAccTitle:Y,setAccDescription:j,getAccDescription:H,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},ft=i(t=>`
  .pieCircle{
