import{p as B}from"./chunk-K2ZEYYM2-BUi_xei4.js";import{p as U}from"./gitGraph-YCYPL57B-RWHQZFFZ-CqnZ-Y2w.js";import{aq as q,q as V,t as X,s as Z,g as j,d as H,c as J,_ as i,l as C,x as K,e as Q,ar as Y,aS as tt,aU as et,aV as z,aW as at,m as rt,aX as it}from"./md-DQtSrqFC.js";import"./chunk-TZBO7MLI-ZOD2vfZi.js";import"../index-CePBHKO3.js";import"../modules/vue-C-U0dUnF.js";import"../modules/shiki-ljQpBpZ7.js";import"../modules/file-saver-LUhfcczZ.js";import"./two-cols.vue_vue_type_script_setup_true_lang-Dse-w_cl.js";import"./context-D7Fvxk3X.js";var W=q.pie,D={sections:new Map,showData:!1,config:W},m=D.sections,w=D.showData,st=structuredClone(W),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,K()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:V,getDiagramTitle:X,setAccTitle:Z,getAccTitle:j,setAccDescription:H,getAccDescription:J,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},ft=i(t=>`
  .pieCircle{
